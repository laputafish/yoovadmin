...
INSERT INTO `commands` (`id`, `name`, `last_checked_at`, `enabled`, `created_at`, `updated_at`) VALUES
	(1, 'checkScanned', '2018-05-28 18:57:14', 1, '2018-05-28 13:33:53', '2018-05-28 18:57:14');
...
-- Dumping data for table yoov_api.documents: ~5 rows (approximately)
/*!40000 ALTER TABLE `documents` DISABLE KEYS */;
INSERT INTO `documents` (`id`, `media_id`, `filename`, `folder_id`, `file_type`, `remark`) VALUES
	(101, 107, 'Declaration.pdf', 3, 'pdf', NULL),
	(102, 108, 'sample.jpg', 3, 'jpg', NULL),
	(103, 109, '下載.png', 3, 'png', NULL),
	(104, 110, 'images.png', 3, 'png', NULL),
	(105, 114, 'bg-video.jpg', 3, 'jpg', NULL);
...
INSERT INTO `equipments` (`id`, `name`, `description`, `occupied_by`, `last_occupied_at`, `remark`, `settings`, `created_at`, `updated_at`) VALUES
	(1, 'scanner', 'Scanner', 0, '2018-05-28 09:49:54', NULL, '{"path":"/home/vagrant/Code/yoov/scan"}', NULL, '2018-05-28 03:46:25');
...
INSERT INTO `folders` (`id`, `_lft`, `_rgt`, `parent_id`, `name`, `description`, `owned_by`, `is_system`, `writable`, `remark`, `created_at`, `updated_at`) VALUES
	(1, 1, 84, NULL, 'root', '', 1, 1, 0, NULL, '2018-05-28 04:20:21', '2018-05-28 04:20:21'),
	...
	(6, 10, 83, 1, 'users', '', 0, 1, 0, NULL, '2018-05-28 04:20:21', '2018-05-28 04:20:21'),
...
-- Dumping data for table yoov_api.medias: ~7 rows (approximately)
/*!40000 ALTER TABLE `medias` DISABLE KEYS */;
INSERT INTO `medias` (`id`, `user_id`, `is_temp`, `path`, `filename`, `created_at`, `updated_at`) VALUES
	(108, 0, 0, 'db/77', 'sample.jpg', '2018-05-28 16:19:30', '2018-05-28 16:19:30'),
	(109, 0, 0, '3c/5e', '下載.png', '2018-05-28 17:51:42', '2018-05-28 17:51:42'),
	(110, 0, 0, '41/b5', 'images.png', '2018-05-28 17:53:15', '2018-05-28 17:53:15'),
	...
	(114, 0, 0, '49/b1', 'bg-video.jpg', '2018-05-28 17:57:52', '2018-05-28 17:57:52');
...
INSERT INTO `meeting_room_bookings` (`id`, `meeting_room_id`, `applicant_id`, `started_at`, `ended_at`, `status`, `remark`) VALUES
	(1, 1, 4, '2018-05-10 13:00:00', '2018-05-10 15:00:00', 'approved', NULL),
	(2, 2, 4, '2018-05-10 13:27:45', '2018-05-10 13:27:47', 'pending', NULL),
	(3, 3, 2, '2018-05-21 14:00:00', '2018-05-21 15:00:00', 'approved', NULL),
	(4, 3, 2, '2018-05-21 12:00:00', '2018-05-21 13:00:00', 'approved', NULL),
	(5, 3, 2, '2018-05-21 18:00:00', '2018-05-21 19:00:00', 'approved', NULL),
	(6, 3, 2, '2018-05-22 08:00:00', '2018-05-22 12:00:00', 'pending', NULL),
	(7, 3, 2, '2018-05-22 11:00:00', '2018-05-22 16:00:00', 'pending', NULL),
	(8, 3, 2, '2018-05-20 18:00:00', '2018-05-20 19:00:00', 'approved', NULL),
	(9, 3, 2, '2018-05-20 11:00:00', '2018-05-20 16:00:00', 'approved', NULL),
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `confirmed`, `conrfirmation_code`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(23, 'YoovDominic', 'dominic@yoov.com', '$2y$10$ij7jb7Ds9krMIUkLIRoaxe3JLM71GvY4WNPqtA0I2OJLLtuF0.mha', 0, NULL, NULL, '2018-05-24 02:57:12', '2018-05-24 02:57:12');
