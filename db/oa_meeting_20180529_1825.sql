...
INSERT INTO `commands` (`id`, `name`, `last_checked_at`, `enabled`, `created_at`, `updated_at`) VALUES
	(1, 'checkScanned', '2018-05-29 18:26:05', 1, '2018-05-28 13:33:53', '2018-05-29 18:26:05');
...
-- Dumping data for table yoov_api.documents: ~4 rows (approximately)
/*!40000 ALTER TABLE `documents` DISABLE KEYS */;
INSERT INTO `documents` (`id`, `media_id`, `filename`, `folder_id`, `file_type`, `remark`) VALUES
	(105, 114, 'bg-video.jpg', 3, 'jpg', NULL),
	(107, 116, '20170815_1015.pdf', 3, 'pdf', NULL),
	(108, 117, '20170724買波鞋優惠贏香港豪宅10年免租.pdf', 3, 'pdf', NULL);
...
-- Dumping data for table yoov_api.medias: ~6 rows (approximately)
...
INSERT INTO `medias` (`id`, `user_id`, `is_temp`, `path`, `filename`, `created_at`, `updated_at`) VALUES
	...
	(116, 0, 0, '4f/46', '20170815_1015.pdf', '2018-05-29 18:01:54', '2018-05-29 18:01:54'),
	(117, 0, 0, '76/9c', '20170724買波鞋優惠贏香港豪宅10年免租.pdf', '2018-05-29 18:02:11', '2018-05-29 18:02:11');
...
-- Dumping data for table yoov_api.oauth_access_tokens: ~76 rows (approximately)
...
-- Dumping data for table yoov_api.oauth_refresh_tokens: ~76 rows (approximately)
