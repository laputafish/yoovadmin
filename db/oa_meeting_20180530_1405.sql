...
INSERT INTO `commands` (`id`, `name`, `last_checked_at`, `enabled`, `mode`, `created_at`, `updated_at`) VALUES
	(1, 'checkScanned', '2018-05-30 14:05:35', 1, 'auto', '2018-05-28 13:33:53', '2018-05-30 14:05:35');
...
-- Dumping data for table yoov_api.documents: ~10 rows (approximately)
...
-- Dumping data for table yoov_api.medias: ~13 rows (approximately)
...
-- Dumping data for table yoov_api.oauth_access_tokens: ~77 rows (approximately)
...
-- Dumping data for table yoov_api.oauth_refresh_tokens: ~77 rows (approximately)
