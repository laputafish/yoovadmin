...
-- Dumping data for table yoov_api.oauth_access_tokens: ~39 rows (approximately)
...
-- Dumping data for table yoov_api.oauth_refresh_tokens: ~39 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `confirmed`, `conrfirmation_code`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Dominic', 'yoov2017@gmail.com', '$2y$10$5sRbMXhBGfkStQPeU2JofuWfFiBdU84bdafobn04DmM6WtsAD1IX.', 0, NULL, NULL, '2017-12-21 03:39:27', '2017-12-21 03:39:27'),
