...
INSERT INTO `commands` (`id`, `name`, `last_checked_at`, `enabled`, `mode`, `created_at`, `updated_at`) VALUES
	(1, 'checkScanned', '2018-05-30 18:44:21', 1, 'auto', '2018-05-28 13:33:53', '2018-05-30 18:44:21');
...
-- Dumping data for table yoov_api.oauth_access_tokens: ~80 rows (approximately)
...
-- Dumping data for table yoov_api.oauth_refresh_tokens: ~80 rows (approximately)
