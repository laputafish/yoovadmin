...
INSERT INTO `meeting_rooms` (`id`, `name`, `capacity`, `location`, `remark`, `equipments`, `created_at`, `updated_at`) VALUES
	(1, 'Room 101', 5, 'Room 101, 1/F', '', 'TV', '2018-05-10 12:05:44', '0000-00-00 00:00:00'),
...
-- Dumping data for table yoov_api.meeting_room_bookings: ~0 rows (approximately)
...
-- Dumping data for table yoov_api.migrations: ~2 rows (approximately)
